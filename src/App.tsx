...
export default function App(){
 ...
 const title:Record<View,string>={overview:greeting(),inventory:'Склад',production:'Производство',clients:'Клиенты',suppliers:'Поставщики',products:'Товары',expenses:'Расходы',ledger:'Журнал'}
